...
>>>>>>> 73c7f421666320ee184daca36035c3af0b2a5a99
...
// verifikasi1
Route::get('/verifikasi_objek_wisata1', [HomeController::class, 'index']);

// Informasi Wisata
Route::get('/verifikasi_objek_wisata2', [HomeController::class, 'infoWisata']);
