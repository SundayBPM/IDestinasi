...
@section('container')
<form class="row gap-3 mt-5 pt-4" action="{{ route('objek-wisata.pembayaran_tiket', $objek_wisata->id) }}" method="POST" class="-3">
    @csrf
    ...
    <div class="col-md-12 d-flex gap-3 justify-content-center align-items-center">
        <div>
            <a href="{{ route('objek-wisata.show', $objek_wisata->id) }}" type="button" class="btn btn-secondary btn-rounded-4 btn-icon btn-sm">
                &larr;
            </a>
        </div>
        <div class="flex-fill">
    ...
    <div class="col-md-4 row gap-3">
        <div class="col-md-12 card p-2">
            <img class="card-img-top w-100" src="{{ asset("img/$objek_wisata->foto") }}" alt="Foto" />
            <div class="card-body">
                <h4 class="card-title">Paket {{ $objek_wisata->nama_destinasi }}</h4>
                <p class="card-text">
                    <span class="fw-bold">Rp. {{ $objek_wisata->harga_tiket }}</span>
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between">
                    ...
                    <span>IDR{{ $objek_wisata->harga_tiket }}</span>
                </div>
                <div class="d-flex justify-content-between">
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <span class="text-warning fw-bold">IDR{{ $objek_wisata->harga_tiket }}</span>
            </div>
        </div>
