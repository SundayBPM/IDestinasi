...
<div class="row gy-3">
    <div class="card col-md-12">
        ...
        <img src="{{ asset("img/$objek_wisata->foto") }}" class="w-100" style="height: 60vh !important; object-fit: cover;" alt="">
        <div class="card-body d-flex w-100">
            ...
            <div class="d-flex flex-column gap-1 flex-fill">
                <h4 class="card-title text-center">{{ $objek_wisata->nama_destinasi }}</h4>
                <p class="card-text text-center">{{ $objek_wisata->lokasi }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="card col-md-12">
        <div class="card-body row">
            ...
            @foreach ($objek_wisata->timeline as $key => $timeline)
            <div class="col-md-12">
    ...
    <div class="card col-md-12">
        <div class="card-body">
            <h4 class="fw-bold">Deskripsi</h4>
            <ul>
                @foreach ($objek_wisata->fasilitas as $fasilitas)
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-row gap-1">
                    ...
                    <button class="btn btn-secondary flex-fill d-flex flex-column btn-tgl" data-index="{{ $loop->iteration }}" data-value="{{ $tanggal->format("Y-m-d") }}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card mt-3">
                    <div class="card-body row">
                        <div class="col-md-12">
                            <h4 class="fw-bold">Paket {{ $objek_wisata->nama_destinasi }}</h4>
                            <div class="d-flex">
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            <div class="d-flex flex-column gap-1">
                                <b>Total</b>
                                <span class="text-warning fs-2 fw-bold">IDR {{ $objek_wisata->harga_tiket }}</span>
                            </div>
                            <div class="align-self-center">
                                @if (auth()->check())
                                <a href="javascript:void(0)" data-link="{{ route('objek-wisata.pembelian_tiket', ['id' => $objek_wisata->id, 'date' => 'rawDate']) }}" class="btn btn-primary btn-pembayaran">
                                    Beli Paket Tour
                                </a>
                                @else
...
@section('scripts')
<script>
    const max_day = "{{ $objek_wisata->timeline->count() }}"
    let tanggal = "";
