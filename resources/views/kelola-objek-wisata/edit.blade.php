                        ...
                        <form method="POST" action="{{ route('kelola-objek-wisata.update', $pengaturanObjekWisata->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <select class="form-select" name="jenis" id="jenis" aria-label="Example select with button addon">
                                    ...
                                    <option value="Pantai" {{ $pengaturanObjekWisata->jenis == 'Pantai' ? 'selected' : '' }}>Pantai</option>
                                    <option value="Alam" {{ $pengaturanObjekWisata->jenis == 'Alam' ? 'selected' : '' }}>Alam</option>
                                    <option value="Budaya" {{ $pengaturanObjekWisata->jenis == 'Budaya' ? 'selected' : '' }}>Budaya</option>
                                    <option value="Pegunungan" {{ $pengaturanObjekWisata->jenis == 'Pegunungan' ? 'selected' : '' }}>Pegunungan</option>
                                    <option value="Wisata Air" {{ $pengaturanObjekWisata->jenis == 'Wisata Air' ? 'selected' : '' }}>Wisata Air</option>
                                </select>
                            </div>
                            <div class="form-row">
                                <label for="foto" class="form-label">Foto Objek Wisata</label>
                                <input class="form-control" type="file" name="foto" id="foto" placeholder="Masukkan URL Foto Objek Wisata" value="{{ $pengaturanObjekWisata->foto }}">
                                <img src="{{ asset('storage/post-images/' . $pengaturanObjekWisata->foto) }}" alt="Foto Objek Wisata" class="img-fluid mt-2">
                            </div>
                            <div class="form-row">
                                <label for="nama_tiket">Nama Tiket</label>
                                <input type="text" class="form-control" name="nama_tiket" id="nama_tiket" placeholder="Masukkan Nama Tiket Objek Wisata" value="{{ $pengaturanObjekWisata->tiket->nama_tiket ?? '' }}" required>
                            </div>
                            <div class="form-row">
                                <label for="harga_tiket">Harga Tiket</label>
                                <input type="text" class="form-control" name="harga_tiket" id="harga_tiket" placeholder="Masukkan Harga Tiket Objek Wisata" value="{{ $pengaturanObjekWisata->tiket->harga_tiket ?? '' }}" required>
                            </div>
